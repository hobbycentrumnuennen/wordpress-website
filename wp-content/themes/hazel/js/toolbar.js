...
$j(document).ready(function() {
    ...
    $j("#panel.default.right a.open").click(function(e){
        ...
        if (margin_right == "-199px"){
            $j("#panel.default").animate({marginRight: "0px"});
            $j("#panel.default").addClass('opened-panel');
            $j(this).addClass('opened');
        }
        else{
            $j("#panel.default").animate({marginRight: "-199px"});
            $j(this).removeClass('opened');
            $j("#panel.default").removeClass('opened-panel');
        }
        return false;
...
//    });
    ...
    $j('ul#tootlbar_header_top_menu li').click(function(){
        if($j(this).attr("data-value") != ""){
            ...
            $j.post(qode_root+'updatesession.php', {theme19_header_top : $j(this).attr("data-value")}, function(data){
                location.reload();
            });
        }
    });
    ...
    $j('ul#tootlbar_page_transitions li').click(function(){
        if($j(this).attr("data-value") != ""){
            ...
            $j.post(qode_root+'updatesession.php', {theme19_page_transitions : $j(this).attr("data-value")}, function(data){
                location.reload();
            });
        }
    });
    ...
    $j('ul#tootlbar_header_type li').click(function(){
        if($j(this).attr("data-value") != ""){
            $j.post(qode_root+'updatesession.php', {theme19_header_type : $j(this).attr("data-value")}, function(data){
                location.reload();
            });
        }
    });
    ...
    $j('#tootlbar_colors .color').each(function(){
        $j(this).on('click',function(){
            ...
            newSkin ="h1 a:hover,\
                    ...
                    .qode_custom_color .q_social_icon_holder.normal_social .simple_social\
					{ \
                    ...
                    .qode_custom_color .q_circle_inner2,\
                    .qode_custom_color .q_font_elegant_holder.circle\
			       { \
