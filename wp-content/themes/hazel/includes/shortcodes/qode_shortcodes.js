   ...
   tinymce.create('tinymce.plugins.qode_shortcodes', {
                  ...
                  if (shortcodes_visible){
                      ...
                      jQuery('#qode_shortcodes_menu_holder').load(url + '/qode_shortcodes_popup.html#qode_shortodes_popup', function(){
						...
						jQuery("#SC_custom_font").click(function(){
							var shortcode = "[custom_font font_family='Open Sans' font_size='19' line_height='26' font_style='none' text_align='left' font_weight='300' color='' background_color='' text_decoration='none' text_shadow='no' letter_spacing='1' padding='0' margin='0']content content content[/custom_font]";
							ed.execCommand('mceInsertContent', false, shortcode);
							jQuery("#qode_shortcodes_menu_holder").remove();
						})
						...
						jQuery("#SC_action").click(function(){
							...
							jQuery.get(url + "/qode_shortcodes_action.php", function(data){
							    ...
							    jQuery('#TB_window #qode_insert_shortcode_button').click(function(){
								    ...
								    var shortcode = "[action full_width='"+full_width+"' content_in_grid='"+content_in_grid+"' type='"+type+"' icon='"+icon+"' icon_size='"+icon_size+"' icon_color='"+icon_color+"' custom_icon='"+custom_icon+"' background_color='"+background_color+"' border_color='"+border_color+"' text_size='"+text_size+"' show_button='"+show_button+"' button_text='"+button_text+"' button_link='"+button_link+"' button_target='"+button_target+"' button_text_color='"+button_text_color+"' button_hover_text_color='"+button_hover_text_color+"' button_background_color='"+button_background_color+"' button_hover_background_color='"+button_hover_background_color+"' button_border_color='"+button_border_color+"' button_hover_border_color='"+button_hover_border_color+"']<br /><br /> content content content <br /><br />[/action]";
									jQuery("#qode_shortcode_form_wrapper").remove()
								    ed.execCommand('mceInsertContent', false, shortcode);		   										   										   tb_remove();
								    return false;
							   });
						...
						jQuery("#SC_horizontal_progress").click(function(){
							...
							jQuery.get(url + "/qode_shortcodes_progress_bar_horizontal.php", function(data){
							   ...
							   jQuery('#TB_window #qode_insert_shortcode_button').click(function(){
								   ...
								   var shortcode = "[progress_bar title='"+title+"' title_color='"+title_color+"' title_tag='"+title_tag+"' title_custom_size='"+title_custom_size+"' percent='"+percent+"' percent_color='"+percent_color+"' percent_font_size='"+percent_font_size+"' percent_font_weight='"+percent_font_weight+"' active_background_color='"+active_background_color+"' active_border_color='"+active_border_color+"' noactive_background_color='"+noactive_background_color+"' height='"+height+"' border_radius='"+border_radius+"']";
								   jQuery("#qode_shortcode_form_wrapper").remove()
								   ed.execCommand('mceInsertContent', false, shortcode);
								   tb_remove();
								   return false;
						...
						jQuery("#SC_latest_post").click(function(){
							...
							jQuery.get(url + "/qode_shortcodes_latest_post.php", function(data){
							   ...
							   jQuery('#TB_window #qode_insert_shortcode_button').click(function(){
								   ...
								   var date_format = jQuery('#TB_window #date_format option:selected').val();
								   var display_author = jQuery('#TB_window #display_author option:selected').val();
								   var shortcode = "[latest_post type='"+type+"' number_of_posts='"+number_of_posts+"' number_of_colums='"+number_of_colums+"' order_by='"+order_by+"' order='"+order+"' category='"+category+"' text_length='"+text_length+"' title_tag='"+title_tag+"' display_category='"+display_category+"' display_date='"+display_date+"' display_comments='"+display_comments+"' display_like='"+display_like+"' display_share='"+display_share+"' display_author='"+display_author+"']";
								   jQuery("#qode_shortcode_form_wrapper").remove()
								   ed.execCommand('mceInsertContent', false, shortcode);		   										   										   tb_remove();
								   return false;
							   });
						...
						jQuery("#SC_message").click(function(){
							...
							jQuery.get(url + "/qode_shortcodes_message.php", function(data){
							    ...
							    jQuery('#TB_window #qode_insert_shortcode_button').click(function(){
									...
									var icon_background_color = jQuery('#TB_window #icon_background_color').val();
									var custom_icon = jQuery('#TB_window #custom_icon').val();
									var close_button_style = jQuery('#TB_window #close_button_style option:selected').val();
								    var shortcode = "[message type='"+type+"' icon_pack='"+icon_pack+"' icon_color='"+icon_color+"' icon_size='"+icon_size+"' icon_background_color='"+icon_background_color+"' custom_icon='"+custom_icon+"' background_color='"+background_color+"' border_color='"+border_color+"' close_button_style='"+close_button_style+"']<h4>Message Title</h4>[/message]";
								    jQuery("#qode_shortcode_form_wrapper").remove()
								    ed.execCommand('mceInsertContent', false, shortcode);		   										   										   tb_remove();
								    return false;
							    });
						...
						jQuery("#SC_pie_chart").click(function(){
							...
							jQuery.get(url + "/qode_shortcodes_pie_chart.php", function(data){
							   ...
							   jQuery('#TB_window #qode_insert_shortcode_button').click(function(){
									...
									var text = jQuery('#TB_window #text').val();
									var text_color = jQuery('#TB_window #text_color').val();
								    var shortcode = "[pie_chart percent='"+percentage+"' percentage_color='"+percentage_color+"' percentage_font_size='"+percentage_font_size+"' percentage_font_weight='"+percentage_font_weight+"' active_color='"+active_color+"' noactive_color='"+noactive_color+"' line_width='"+line_width+"' title='"+title+"' title_color='"+title_color+"' title_tag='"+title_tag+"' text='"+text+"' text_color='"+text_color+"']";
								    jQuery("#qode_shortcode_form_wrapper").remove()
								    ed.execCommand('mceInsertContent', false, shortcode);
								    tb_remove();
								    return false;
						...
						jQuery("#SC_portfolio_list").click(function(){
							...
							jQuery.get(url + "/qode_shortcodes_portfolio_list.php", function(data){
							   ...
							   jQuery('#TB_window #qode_insert_shortcode_button').click(function(){
									...
									var filter_color = jQuery('#TB_window #filter_color').val();
                                    ...
                                    var title_tag = jQuery('#TB_window #title_tag option:selected').val();
									var shortcode = "[portfolio_list type='" + type + "' box_background_color='"+box_background_color+"' box_border='"+box_border+"' box_border_width='"+box_border_width+"' box_border_color='"+box_border_color+"' columns='"+columns+"' image_size='"+image_size+"' order_by='"+order_by+"' order='"+order+"' number='"+number+"' category='"+category+"' selected_projects='"+selected_projects+"' filter='"+filter+"' filter_color='"+filter_color+"' lightbox='"+lightbox+"' show_load_more='" + show_load_more +"' title_tag='"+title_tag+"']";
									jQuery("#qode_shortcode_form_wrapper").remove()
									ed.execCommand('mceInsertContent', false, shortcode);		   										   										   tb_remove();
									return false;
							   });
						...
						jQuery("#SC_portfolio_slider").click(function(){
							...
							jQuery.get(url + "/qode_shortcodes_portfolio_slider.php", function(data){
							   ...
							   jQuery('#TB_window #qode_insert_shortcode_button').click(function(){
								   ...
								   var separator = jQuery('#TB_window #separator option:selected').val();
                                    var image_size = jQuery('#TB_window #image_size option:selected').val();
									var shortcode = "[portfolio_slider order_by='"+order_by+"' order='"+order+"' number='"+number+"' category='"+category+"' selected_projects='"+selected_projects+"' lightbox='"+lightbox+"' title_tag='"+title_tag+"' text_align='"+text_align+"' separator='"+separator+"' image_size='"+image_size+"']";
									jQuery("#qode_shortcode_form_wrapper").remove()
									ed.execCommand('mceInsertContent', false, shortcode);		   										   										   tb_remove();
									return false;
							   });
						...
						jQuery("#SC_separator").click(function(){
							...
							jQuery.get(url + "/qode_shortcodes_separator.php", function(data){
							   ...
							   jQuery('#TB_window #qode_insert_shortcode_button').click(function(){
									...
									var shortcode = "[vc_separator type='"+type+"' width='"+width+"' position='"+position+"' color='"+color+"' border_style='"+border_style+"' thickness='"+thickness+"'  up='"+top+"' down='"+bottom+"']";
									jQuery("#qode_shortcode_form_wrapper").remove()
									ed.execCommand('mceInsertContent', false, shortcode);		   										   										   tb_remove();
									return false;
							   });
							...
							jQuery.get(url + "/qode_shortcodes_social_icon.php", function(data){
							   ...
							   jQuery('#TB_window #qode_insert_shortcode_button').click(function(){
									...
									var fe_icon = jQuery('#TB_window #fe_icon option:selected').val();
							   		...
							   		var border_width = jQuery('#TB_window #border_width').val();
							   		var border_color = jQuery('#TB_window #border_color').val();
								    var shortcode = "[social_icons type='"+type+"' icon_pack='"+icon_pack+"' size='"+size+"' link='"+link+"' target='"+target+"' icon_color='"+icon_color+"' 'background_color='"+background_color+"' border_width='"+border_width+"' border_color='"+border_color+"' /]";
									jQuery("#qode_shortcode_form_wrapper").remove()
								    ed.execCommand('mceInsertContent', false, shortcode);		   										   										   tb_remove();
								    return false;
							   });
						...
						jQuery("#SC_testimonials").click(function(){
							...
							jQuery.get(url + "/qode_shortcodes_testimonials.php", function(data){
							   ...
							   jQuery('#TB_window #qode_insert_shortcode_button').click(function(){
								    ...
								    var shortcode = "[testimonials category='"+category+"' number='"+number+"' text_color='"+text_color+"' text_font_size='"+text_font_size+"' author_text_color='"+author_text_color+"' show_navigation='"+show_navigation+"' navigation_style='"+navigation_style+"' auto_rotate_slides='"+auto_rotate_slides+"' animation_type='"+animation_type+"']";
						    		jQuery("#qode_shortcode_form_wrapper").remove()
								    ed.execCommand('mceInsertContent', false, shortcode);		   										   										   tb_remove();
								    return false;
							   });
						...
						jQuery("#SC_interactive_banners").click(function(){
							...
							jQuery.get(url + "/qode_shortcodes_interactive_banners.php", function(data){
							    ...
							    jQuery('#TB_window #qode_insert_shortcode_button').click(function(){
                                    ...
                                    var title_size = jQuery('#TB_window #title_size').val();
                                    var title_tag = jQuery('#TB_window #title_tag option:selected').val();
									var shortcode = "[interactive_banners layout_width='"+layout_width+"' image='"+image+"' icon_pack='"+icon_pack+"' fa_icon='"+fa_icon+"' fe_icon='"+fe_icon+"' icon_custom_size='"+icon_custom_size+"' icon_color='"+icon_color+"' title='"+title+"' title_color='"+title_color+"' title_size='"+title_size+"' title_tag='"+title_tag+"']<p>Enter text here</p>[/interactive_banners]";
									jQuery("#qode_shortcode_form_wrapper").remove()
									ed.execCommand('mceInsertContent', false, shortcode);		   										   										   tb_remove();
									return false;
							   });
						...
						jQuery("#SC_tabs").click(function(){
							...
							jQuery.get(url + "/qode_shortcodes_team.php", function(data){
							   ...
							   jQuery('#TB_window #qode_insert_shortcode_button').click(function(){
									...
									var background_color = jQuery('#TB_window #background_color').val();
								   var box_border = jQuery('#TB_window #box_border').val();
								   var show_separator = jQuery('#TB_window #show_separator option:selected').val();
                      ...
                      jQuery("#SC_clients").click(function(){
                          ...
                          jQuery.get(url + "/qode_shortcodes_clients.php", function(data){
                              ...
                              form.appendTo('body').hide();
                              colorPicker();
                              tb_show( 'Select Clients Shortcode', '#TB_inline?width=' + W + '&height=' + H + '&inlineId=qode_shortcode_form_wrapper' );
                              jQuery('#TB_window #qode_insert_shortcode_button').click(function(){
                                  var columns = jQuery('#TB_window #columns option:selected').val();
                                  var shortcode = "[qode_clients columns='"+columns+"'][qode_client image='' link='' link_target=''][/qode_clients]";
                                  jQuery("#qode_shortcode_form_wrapper").remove();
                                  ed.execCommand('mceInsertContent', false, shortcode);
                                  tb_remove();
                                  return false;
      ...
      getInfo : function() {
         return {
            ...
            authorurl : 'http://www.select-themes.com/',
            infourl : 	'http://www.select-themes.com/',
            version : "1.0"
         };
      }
   });
