...
if(isset($qode_options['number_of_chars_small_image']) && $qode_options['number_of_chars_small_image'] != "") {
	qode_set_blog_word_count($qode_options['number_of_chars_small_image']);
}
