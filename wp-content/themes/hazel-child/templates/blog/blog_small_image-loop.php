					...
					<div class="post_text_inner">
						...
						<div class="post_info">
							...
							<?php if($blog_hide_comments != "yes"){ ?>
								<a class="post_comments" href="<?php comments_link(); ?>" target="_self"><i class="icon_comment_alt" aria-hidden="true"></i><span><?php comments_number('0', '1', '%'); ?></span></a>
							<?php } ?>
					...
					<div class="post_text_inner">
						...
						<div class="post_info">
							...
							<?php if($blog_hide_comments != "yes"){ ?>
								...
								<i class="icon_comment_alt" aria-hidden="true"></i><span><?php comments_number('0', '1', '%'); ?></span></a>
							<?php } ?>
